...
<head>
  ...
  <title>EditPost - Advance CMS System</title>
          ...
          <div class="card bg-secondary text-light mb-3">
            <div class="card-body bg-dark">
              <div class="form-group">
                ...
                <input class="form-control" type="text" name="PostTitle" id="PostTitle" placeholder="Type title here" value="<?php echo $TitleToBeUpdated; ?>">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="PostDescription" id="Post" cols="80" rows="8" placeholder="Type Your Post Here">
