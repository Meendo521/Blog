...
<head>
  ...
  <title>AddNewPost - Advance CMS System</title>
...
<body>
  ...
  <header class="bg-dark text-white py-3">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h1><i class="fas fa-edit" style="background: #27aae1;"></i> ADD NEW POSTS</h1>
        </div>
      </div>
    </div>
  </header>
          ...
          <div class="card bg-secondary text-light mb-3">
            <div class="card-body bg-dark">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" name="PostDescription" id="Post" cols="80" rows="8" placeholder="Type Your Post Here"></textarea>
              </div>
              <div class="row">
